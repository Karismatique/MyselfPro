...
export default function CreateInvoiceForm() {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6">
        <h3 id="form-title" className="text-lg font-bold text-slate-900 dark:text-white">
      ...
      <form ref={formRef} action={formAction} className="space-y-4">
        ...
        <div>
          <label htmlFor="amount" className="block text-xs font-semibold text-slate-600 dark:text-slate-300 uppercase tracking-wider mb-2">
            Montant de la Facture (€ H.T.) <span className="text-teal-600 dark:text-teal-400" aria-hidden="true">*</span>
            <span className="sr-only">(champ requis)</span>
          </label>
